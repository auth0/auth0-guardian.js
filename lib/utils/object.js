 ...
 */
var reduce = function reduce(obj, fn, init) {
  var current = init;
 ...
 */
var mapKeyValue = function mapKeyValue(obj,
 ...
 * @returns {object} result object
 */
var deepMapKeyValue = function deepMapKeyValue(obj,
  transformKey, transformValue) {
...
exports.deepMapKeyValue = deepMapKeyValue;
 ...
 * @returns {object} result object
 */
var assignOne = function assignOne(root, setObj) {
