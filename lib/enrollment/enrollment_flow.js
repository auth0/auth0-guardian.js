...
const factorEntity = require('../entities/factor');

const strategies = {
  otp: require('./strategies/otp_enrollment_strategy'), // eslint-disable-line global-require
  push: require('./strategies/pn_enrollment_strategy'), // eslint-disable-line global-require
  sms: require('./strategies/sms_enrollment_strategy') // eslint-disable-line global-require
};
...
module.exports = class EnrollmentFlow {
   ...
   */
  getAvailableFactors() {
    return factorEntity.getAvailableFactors(this.data.factors);
  }
